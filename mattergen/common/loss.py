...
from mattergen.diffusion.losses import LossReduction, SummedFieldLoss, denoising_score_matching
...
class MaterialsLoss(SummedFieldLoss):
    def __init__(
        ...
        field_reduce: Literal["sum", "mean"] = "sum" if reduce == "per_atom_mean" else reduce
